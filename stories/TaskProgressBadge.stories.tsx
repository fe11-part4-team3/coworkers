...
import TaskProgressBadge from '@/app/[teamId]/(index)/TaskProgressBadge';

export default {
  title: 'Components/TaskProgressBadge',
  component: TaskProgressBadge,
} as Meta;

const Template: StoryFn<typeof TaskProgressBadge> = (args) => (
  <TaskProgressBadge {...args} />
);
