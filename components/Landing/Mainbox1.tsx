...
const MainBox1 = () => {
  return (
    <div className="relative mt-pr-60 h-pr-419 w-pr-996 rounded-pr-40 bg-gradient-to-r from-brand-primary to-brand-tertiary p-pr-1 mo:h-pr-467 mo:w-pr-343 ta:h-pr-354 ta:w-pr-696">
      <div className="relative flex h-full w-full rounded-pr-40 bg-b-primary shadow-lg backdrop-blur-md mo:flex-col-reverse">
        ...
        <div className="flex h-full w-1/2 items-center justify-start mo:w-full mo:items-start mo:justify-start">
          <div className="absolute bottom-pr-124 ml-pr-160 flex h-pr-120 w-pr-157 flex-col gap-pr-16 text-24m mo:absolute mo:left-pr-54 mo:top-pr-48 mo:m-0 mo:h-pr-106 mo:w-pr-118 ta:ml-pr-110 tamo:h-pr-106 tamo:w-pr-118 tamo:text-18m">
