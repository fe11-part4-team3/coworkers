...
const MainBox2 = () => {
  return (
    <div className="relative h-pr-419 w-pr-996 rounded-pr-40 bg-b-secondary mo:h-pr-467 mo:w-pr-343 ta:h-pr-354 ta:w-pr-696">
      <div className="relative flex h-full w-full mo:flex-col-reverse">
        <div className="flex h-full w-1/2 items-center justify-end mo:w-full mo:items-end mo:justify-start">
          <div className="mr-pr-160 flex h-pr-120 w-pr-157 flex-col gap-pr-16 text-24m mo:absolute mo:bottom-pr-52 mo:left-pr-54 mo:h-pr-106 mo:w-pr-129 ta:bottom-pr-124 ta:mr-pr-110 tamo:h-pr-106 tamo:w-auto tamo:text-18m">
            <IconBox imageUrl="messageicon.svg" alt="Message Icon" left />
            <p className="whitespace-nowrap text-right leading-none text-t-primary mo:text-left">
              간단하게 멤버들을
              <br />
              초대해요
            </p>
