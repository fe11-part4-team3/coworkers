  ...
  return (
    <div className="flex w-screen flex-col items-center">
      ...
      <section className="relative flex flex-col items-center gap-pr-80">
        <div className="relative mt-pr-60 h-pr-419 w-pr-996 rounded-pr-40 bg-gradient-to-r from-brand-primary to-brand-tertiary p-pr-1">
          <div className="relative flex h-full w-full rounded-pr-40 bg-b-primary shadow-lg backdrop-blur-md">
            ...
            <Image
              ...
              width={291}
              height={338}
              className="absolute bottom-0 left-pr-174 h-pr-338 w-pr-291 object-contain"
            />

            {/* 아이콘텍스트박스 */}
            <div className="absolute right-pr-181 top-pr-155 h-pr-120 w-pr-157">
