...
function TextContentCard({ tasks, text, icon }: TextContentCardProps) {
  return (
    <div className="team_xmo:w-full team_xmo:max-w-pr-280 team_mo:w-pr-182 flex w-pr-400 items-center justify-between rounded-pr-12 bg-b-tertiary p-pr-16 transition-all duration-300 ta:w-pr-280">
